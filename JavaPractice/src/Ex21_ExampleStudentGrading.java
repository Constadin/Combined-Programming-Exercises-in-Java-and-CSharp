...
You've already completed an initial version of the application. The Starter code project for this Guided project module
 includes a Program.cs file that provides the following code features:

The code declares variables used to define student names and individual exam scores for each student.
The code includes the variables and algorithms used to sum the exam scores and calculate the average exam score
 for each student.
The code includes a hard coded letter grade that the developer must apply manually.
The code includes System.out.println() statements to display the student grading report.
...
grading chart that shows the letter grade corresponding to numeric scores.
   ...
   0  - 59    F
*/
public class Ex21_ExampleStudentGrading {
    ...
    public static void main(String[]args) {
        ...
        for(String name : studentNames){
            ...
            else if (currentStudent.equals("Becky"))
                currentStudentScores = beckyScores;
            else if (currentStudent.equals("Chris"))
                currentStudentScores = chrisScores;
            else if (currentStudent.equals("Eric"))
            ...
            for(int score : currentStudentScores){
                gradedAssignments += 1;
            ...
            System.out.println(currentStudent + "\t\t" + currentStudentGrade + "\t" + currentStudentLetterGrade);
        }
     }
}
